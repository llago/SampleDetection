...
annotation_file = 'D:\Faculdade\Mono\Gururani\Dataset\annotation.csv';
suspect_dir = 'D:\Faculdade\Mono\Gururani\Dataset\Copied\';
sample_dir = 'D:\Faculdade\Mono\Gururani\Dataset\Originals\';
time_dir = 'D:\Faculdade\Mono\Gururani\Dataset\time_annotations\';

annotation = csvread(annotation_file);
load D:\Faculdade\Mono\Lucas\Teste1\new_features
%figure; hold on;
%costs = cell(1,80);
%locs = cell(1,80);
%labels = cell(1,40);
...
save ('D:\Faculdade\Mono\Lucas\Teste1\evaluation_script_new_results.mat', 'precision', 'recall', 'f_measure', 'tp', 'fp', 'fn')
