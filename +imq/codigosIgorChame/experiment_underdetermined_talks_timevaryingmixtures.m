function experiment_underdetermined_talks_mixtures ()
    ...
    %% Naming Datasets
    % dataset_name{1} = 'smt_conversa_03';
    dataset_name{1} = 'smt_conversa_04';
    ...
    % mixture_full_path{1} = [ basic_path 'bases/lw_fala/conversa/smt_conversa_03_mix.wav' ];
    mixture_full_path{1} = [ basic_path 'bases/lw_fala/conversa/smt_conversa_04_mix.wav' ];

    % Setting path to sources references
    % source_ref_full_path{1}{1} = [ basic_path 'bases/lw_fala/conversa/smt_conversa_03_sim_1.wav' ]; 
    % source_ref_full_path{1}{2} = [ basic_path 'bases/lw_fala/conversa/smt_conversa_03_sim_2.wav' ]; 
 
    source_ref_full_path{1}{1} = [ basic_path 'bases/lw_fala/conversa/smt_conversa_04_sim_1.wav' ]; 
    source_ref_full_path{1}{2} = [ basic_path 'bases/lw_fala/conversa/smt_conversa_04_sim_2.wav' ];
