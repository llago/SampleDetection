    ...
    %% Naming Datasets
    %dataset_name{1} = 'SiSEC2008_wdrums';
    %dataset_name{2} = 'SiSEC2008_nodrums';
    dataset_name{1} = 'Rocamora_cuerda_de_tres';
    ...
    basic_path = 'C:\Faculdade\IC\NMF\simulacoes_Lucas\audiosTeste\Rocamora_Lucas';
    
    %% Setting mixture path
    %mixture_full_path{1} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2008_dev/dev1_wdrums_inst_mix.wav' ];
    %mixture_full_path{2} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2008_dev/dev1_nodrums_inst_mix.wav' ];
    mixture_full_path{1} = [ basic_path 'cuerda_de_tres_stereo_editado.wav' ];
%     mixture_full_path{2} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2010_dev/dev2_wdrums_inst_mix.wav' ];
    ...
    %source_ref_full_path{1}{1} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2008_dev/dev1_wdrums_inst_sim_1.wav' ]; 
    %source_ref_full_path{1}{2} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2008_dev/dev1_wdrums_inst_sim_2.wav' ]; 
    %source_ref_full_path{1}{3} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2008_dev/dev1_wdrums_inst_sim_3.wav' ]; 
    
    %source_ref_full_path{2}{1} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2008_dev/dev1_nodrums_inst_sim_1.wav' ]; 
    %source_ref_full_path{2}{2} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2008_dev/dev1_nodrums_inst_sim_2.wav' ]; 
    %source_ref_full_path{2}{3} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2008_dev/dev1_nodrums_inst_sim_3.wav' ]; 

    source_ref_full_path{1}{1} = [ basic_path 'cuerda_de_tres_chico_editado.wav' ]; 
    source_ref_full_path{1}{2} = [ basic_path 'cuerda_de_tres_piano_editado.wav' ]; 
    source_ref_full_path{1}{3} = [ basic_path 'cuerda_de_tres_repique_editado.wav' ]; 
...
%     source_ref_full_path{2}{3} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2010_dev/dev2_wdrums_inst_sim_3.wav' ]; 
    ...
    NMF_CompPerSrcNum{1} = [ 6];
    %NMF_CompPerSrcNum{2} = [ 6];
...
%     implementation_name{6} = 'ntf_inst_em_is';
    implementation_name{1} = 'ntfclus_inst_mu_is';
    implementation_name{2} = 'ntfclus_inst_mu_kl';
    addpath('C:\Faculdade\IC\NMF\+imq\+codigosIgorChame\src_implementations\'); % implementations
