...
%      dataset_name{4} = 'SiSEC2010_male4';
    dataset_name{3} = 'SiSEC2010_femalemale_wChannDiff';
    dataset_name{4} = 'SiSEC2010_femalemale_noChannDiff';
...
%      mixture_full_path{4} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2010_dev/dev2_male4_inst_mix.wav' ];
    mixture_full_path{3} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2010_dev/SiSEC2010_femalemale_1_wChannDiff_mix.wav' ];
    mixture_full_path{4} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2010_dev/SiSEC2010_femalemale_1_noChannDiff_mix.wav' ];
...
%      source_ref_full_path{4}{4} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2010_dev/dev2_male4_inst_sim_4.wav' ];
    ...
    source_ref_full_path{3}{1} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2010_dev/SiSEC2010_femalemale_1_wChannDiff_sim_1.wav' ]; 
    source_ref_full_path{3}{2} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2010_dev/SiSEC2010_femalemale_1_wChannDiff_sim_2.wav' ]; 
    
    source_ref_full_path{4}{1} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2010_dev/SiSEC2010_femalemale_1_noChannDiff_sim_1.wav' ]; 
    source_ref_full_path{4}{2} = [ basic_path 'bases/SiSEC_2013_Tasks/1.Underdetermined_speech_and_music_mixtures/SiSEC2010_dev/SiSEC2010_femalemale_1_noChannDiff_sim_2.wav' ];
