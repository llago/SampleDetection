...
function [SDRi,ISRi,SIRi,SARi,permi,cost] = ntf_inst_mu_kl ( NMF_CompPerSrcNum, nsrc, stft_win_len, max_iterations, mixture_full_path, source_ref_full_path, dataset_name, experiment_name, init_param)
    ...
    for repeat=1:repeat_total,
        ...
        [Q_init, W_init, H_init] = init_ntf_mu_kl_mag(X, K, init_rnd, init_iterations, after_iterations);
        ...
        tic;
        [Q, W, H, cost(repeat,:)] = ntf_mu_kl(V, max_iterations, Q_init, W_init, H_init);
