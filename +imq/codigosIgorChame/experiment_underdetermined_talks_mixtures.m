function experiment_underdetermined_talks_mixtures ()
    ...
    %% Naming Datasets
    dataset_name{1} = 'smt_conversa_01';
    dataset_name{2} = 'smt_conversa_02';
    ...
    mixture_full_path{1} = [ basic_path 'bases/lw_fala/conversa/smt_conversa_01_mix.wav' ];
    mixture_full_path{2} = [ basic_path 'bases/lw_fala/conversa/smt_conversa_02_mix.wav' ];

    % Setting path to sources references
    source_ref_full_path{1}{1} = [ basic_path 'bases/lw_fala/conversa/smt_conversa_01_sim_1.wav' ]; 
    source_ref_full_path{1}{2} = [ basic_path 'bases/lw_fala/conversa/smt_conversa_01_sim_2.wav' ]; 
  
    source_ref_full_path{2}{1} = [ basic_path 'bases/lw_fala/conversa/smt_conversa_02_sim_1.wav' ]; 
    source_ref_full_path{2}{2} = [ basic_path 'bases/lw_fala/conversa/smt_conversa_02_sim_2.wav' ]; 
