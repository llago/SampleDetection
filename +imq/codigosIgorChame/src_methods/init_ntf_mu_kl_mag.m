function [Q, W, H] = init_ntf_mu_kl_mag (X, K, init_rnd, init_iterations, after_iterations)

    %
    % [Q, W, H] = init_ntf_mu_kl_mag(X, K);
    %
    ...
    for init_ind = 1:init_rnd
        ...
        [Q,W,H,E] = ntf_mu_kl(V, init_iterations, Q_ini, W_ini, H_ini);
    ...
    if after_iterations == 0,
        ...
        [Q, W, H, E] = ntf_mu_kl(V, after_iterations, Q_best, W_best, H_best);
    end
